...
class GraphCreatorStrategyUnitTest {
    ...
    @Test
    void Should_CreateExpenseChart_When_ListIsEmpty() {

        //given
        List<ChartExpense> expenses = new ArrayList<>();
    ...
    @Test
    void Should_Return2ExpenseeChartCategories_WhenMultipleExpenseCategories() {

        //given
        List<ChartExpense> expenses = new ArrayList<>();
        expenses.add(ChartExpense.builder().expenseCategory("FOOD").moneyValue(31.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("CAR").moneyValue(32.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("CAR").moneyValue(33.0).build());
    ...
    void  Should_ReturnCorrectMoneyAmount_When_MultipleExpenseCategories() {
        ...
        //given
        List<ChartExpense> expenses = new ArrayList<>();
        expenses.add(ChartExpense.builder().expenseCategory("FOOD").moneyValue(32.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("FOOD").moneyValue(33.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("CAR").moneyValue(45.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("CAR").moneyValue(22.0).build());
    ...
    @Test
    void Should_CreateChartWithOneExpenseCategory() {
    ...
    void Should_ReturnCorrectExpenseDistribution_When_MultipleExpenseCategories() {
        ...
        //given
        List<ChartExpense> expenses = new ArrayList<>();
        expenses.add(ChartExpense.builder().expenseCategory("FOOD").moneyValue(30.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("CAR").moneyValue(50.0).build());
        expenses.add(ChartExpense.builder().expenseCategory("DEBTS").moneyValue(20.0).build());
